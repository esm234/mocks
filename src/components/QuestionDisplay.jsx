...
<div 
  className="w-full bg-[#03A9F4] text-white flex items-center justify-between px-4 md:px-8 py-3
  fixed bottom-0 left-0 z-50"
  style={{
    paddingBottom: "env(safe-area-inset-bottom)" // علشان يراعي الـ notch والـ toolbar
  }}
>
  {/* زر السابق */}
  <button
